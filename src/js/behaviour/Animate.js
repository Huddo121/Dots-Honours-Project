define(function (require) {
    ...
    Animate.prototype._animate = function (element, options) {
        ...
        element
            ...
            .animate(options.animate, {
                duration: options.animate.duration || 1500,
                easing: options.animate.easing || 'easeOutElastic',
                complete: options.animate.complete || function () {},
                queue: options.animate.queue || true,
                always: function () {
    ...
    Animate.prototype.move = function (element, options) {
        // Define the options if they do not exist.
        options = options || {};
        // Add the CSS options.
        options.css = options.css || {};
